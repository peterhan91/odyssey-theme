...
title: Theme Setup
description: Learn how to setup Odyssey Theme's seo, logo, nav items, etc.
---
...
The default Open Graph image is pointed at the hero artwork located at `/public/assets/images/home/classic-hero.jpg`. To swap in your own asset, update the `image` prop when using the `<BaseHead />` component or change the default URL inside `src/components/head/BaseHead.astro` to reference a file that you place under the `public/` directory.
